...
$lang = array_merge($lang, array(
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> 'Μέγιστο Μέγεθος Κάθε Αρχείου. Εάν η τιμή είναι 0, το μεταφορτώσιμο μέγεθος αρχείου περιορίζεται μόνο από τις ρυθμίσεις του PHP σας.',
