...
$lang = array_merge($lang, array(
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'Αυτό εδώ καθιστά την Δ. Συζήτηση μη διαθέσιμη για χρήστες εκτός από διαχειριστές και συντονιστές. Μπορείτε επίσης να προσθέσετε ένα μικρό μήνυμα (255 χαρακτήρες) το οποίο θα εμφανίζεται εάν θέλετε.',
	...
	'WARNINGS_EXPIRE_EXPLAIN'		=> 'Ο αριθμός των ημερών, των οποίων μετά θα διαγραφούν αυτόματα οι προειδοποιήσεις από το προφίλ του μέλους. Θέστε την τιμή 0 για να μείνουν οι προειδοποιήσεις μόνιμα',
));
...
$lang = array_merge($lang, array(
	...
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Η διαδρομή στον κύριο φάκελο του phpBB στην οποία θα αποθηκευτούν τα άβαταρ, π.χ. <samp>images/avatars/upload</samp>.<br />Η αποθήκευση των άβαταρ <strong>δεν θα είναι διαθέσιμη</strong> αν αυτή η διαδρομή δεν έχει δικαιώματα εγγραφής.',
	...
	'MAX_FILESIZE_EXPLAIN'			=> 'Για άβαταρ που φορτώνονται. Εάν η τιμή είναι 0, το μεταφορτώσιμο μέγεθος αρχείου περιορίζεται μόνο από τις ρυθμίσεις του PHP σας.',
...
$lang = array_merge($lang, array(
	...
	'CHAR_LIMIT_EXPLAIN'			=> 'Ο αριθμός χαρακτήρων που επιτρέπεται σε μια δημοσίευση/προσωπικό μήνυμα. Θέστε αυτό 0 χωρίς όριο.',
	...
	'MAX_POST_FONT_SIZE_EXPLAIN'	=> 'Μέγιστο μέγεθος γραμματοσειράς που επιτρέπεται στην δημοσίευση. Θέστε αυτό 0 για χωρίς όριο γραμματοσειράς.',
	...
	'QUOTE_DEPTH_LIMIT_EXPLAIN'		=> 'Μέγιστος αριθμός παραθέσεων που επιτρέπεται σε μια δημοσίευση. Θέστε αυτό 0 για χωρίς όριο.',
	'SMILIES_LIMIT'					=> 'Μέγιστος αριθμός εικονιδίων ',
	'SMILIES_LIMIT_EXPLAIN'			=> 'Μέγιστος αριθμός εικονιδίων που επιτρέπεται ανά δημοσίευση. Θέστε αυτό 0 για χωρίς όριο.',
...
$lang = array_merge($lang, array(
	...
	'MAX_SIG_FONT_SIZE_EXPLAIN'		=> 'Μέγιστο μέγεθος γραμματοσειράς που επιτρέπεται στις υπογραφές των μελών. Θέστε αυτό 0 για χωρίς όριο μέγεθος.',
	...
	'MAX_SIG_SMILIES_EXPLAIN'		=> 'Μέγιστος αριθμός εικονιδίων που επιτρέπεται ανά υπογραφή. Θέστε αυτό 0 για χωρίς όριο εικονίδια.',
	'MAX_SIG_URLS'					=> 'Μέγιστος αριθμός συνδέσμων στις υπογραφές',
	'MAX_SIG_URLS_EXPLAIN'			=> 'Μέγιστος αριθμός συνδέσμων που επιτρέπεται ανά υπογραφή. Θέστε αυτό 0 για χωρίς όριο σύνδεσμοι.',
));
