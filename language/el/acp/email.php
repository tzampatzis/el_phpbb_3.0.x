...
$lang = array_merge($lang, array(
	'ACP_MASS_EMAIL_EXPLAIN'		=> 'Εδώ μπορείτε να στείλετε μήνυμα αλληλογραφίας σε όλα τα μέλη ή στα μέλη μιας ομάδας <strong>πού έχουν ενεργοποιημένη την λήψη μηνυμάτων ομαδικής αλληλογραφίας</strong>. Για να επιτύχει αυτό ένα ηλεκτρονικό ταχυδρομείο θα σταλεί από την διεύθυνση ηλεκτρονικού ταχυδρομείου του διαχειριστή που έχετε προσθέσει, ένα τυφλό αντίγραφο (BCC) θα σταλεί σε όλους τους παραλήπτες. Η ρύθμιση προεπιλογής πρόκειται να περιλάβει μόνο 20 παραλήπτες σε ένα τέτοιο ηλεκτρονικό ταχυδρομείο, για περισσότερους παραλήπτες θα σταλούν περισσότερα ηλεκτρονικά ταχυδρομεία. Αν στέλνετε το μήνυμα σε μια μεγάλη ομάδα κάντε υπομονή και μην σταματήσετε την σελίδα κατά την διάρκεια της αποστολής. Είναι λογικό για μια ομαδική αποστολή να πάρει κάποιο χρόνο, θα ενημερωθείτε όταν η διαδικασία ολοκληρωθεί.',
