...
$lang = array_merge($lang, array(
	...
	'UNTIL'						=> 'Μέχρι',
	'USER_BAN'					=> 'Αποκλεισμός ενός ή περισσοτέρων χρηστών με βάση το όνομα χρήστη',
	...
	'USER_UNBAN'				=> 'Άρση αποκλεισμού ή απεπιλογή χρηστών με βάση το όνομα χρήστη',
	'USER_UNBAN_EXPLAIN'		=> 'Μπορείτε να άρετε τον αποκλεισμό (ή να απεπιλέξετε) περισσότερους χρήστες χρησιμοποιώντας τον κατάλληλο συνδυασμό ποντικιού και πληκτρολογίου του υπολογιστή σας και του Πλοηγού σας. Τα εξαιρούμενα μέλη θα είναι υπογραμμισμένοι.',
