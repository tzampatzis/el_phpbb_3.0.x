...
$lang = array_merge($lang, array(
	...
	'SHOW_NOVALUE_FIELD'			=> 'Εμφάνιση πεδίου εάν η τιμή δεν επιλέχθηκε',
	'SHOW_NOVALUE_FIELD_EXPLAIN'	=> 'Καθορίζει αν το πεδίο προφίλ πρέπει να εμφανίζεται όταν η τιμή δεν επιλέχθηκε για προαιρετικά πεδία ή εάν η τιμή δεν έχει επιλεγεί ακόμα για τα απαιτούμενα πεδία.',
