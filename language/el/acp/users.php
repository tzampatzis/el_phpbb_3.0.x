...
$lang = array_merge($lang, array(
	...
	'CANNOT_DEACTIVATE_FOUNDER'		=> 'Δεν σας επιτρέπεται να απενεργοποιήσετε τον λογαριασμό του ιδρυτή.',
	'CANNOT_DEACTIVATE_YOURSELF'	=> 'Δεν μπορείτε να απενεργοποιήσετε τον δικό σας λογαριασμό.',
	'CANNOT_FORCE_REACT_BOT'		=> 'Δεν σας επιτρέπεται να απενεργοποιήσετε bot λογαριασμούς. Παρακαλώ επανενεργοποιήστε την στατική διεύθυνση του bot μέσα στην σελίδα.',
	'CANNOT_FORCE_REACT_FOUNDER'	=> 'Δεν σας επιτρέπεται να επιβάλετε τον ιδρυτή να κάνει επανενεργοποίηση του λογαριασμού.',
	'CANNOT_FORCE_REACT_YOURSELF'	=> 'Δεν σας επιτρέπεται να επιβάλετε τον εαυτό σας να επανενεργοποιήσετε τον λογαριασμό.',
	'CANNOT_REMOVE_ANONYMOUS'		=> 'Δεν μπορείτε να διαγράψετε τον λογαριασμό του επισκέπτη.',
	'CANNOT_REMOVE_FOUNDER'			=> 'Δεν μπορείτε να διαγράψετε λογαριασμούς ιδρυτών.',
	...
	'DELETE_USER_EXPLAIN'	=> 'Παρακαλώ σημειώστε η διαγραφή μελών είναι οριστική, και δεν μπορεί να γίνει επαναφορά. Μη αναγνωσμένα προσωπικά μηνύματα που αποστέλλονται από αυτό το μέλος θα διαγραφούν και δεν θα είναι διαθέσιμα στους αποδέκτες τους',

	'FORCE_REACTIVATION_SUCCESS'	=> 'Η επανενεργοποίηση επιβλήθηκε επιτυχώς.',
	'FOUNDER'						=> 'Ιδρυτής',
	'FOUNDER_EXPLAIN'				=> 'Οι ιδρυτές έχουν όλα τα δικαιώματα διαχείρισης και δεν μπορούν ποτέ να αποκλειστούν, διαγραφούν ή να αλλάξουν.',
	...
	'USER_NO_POSTS_TO_DELETE'		=> 'Το μέλος δεν έχει καμία δημοσίευση για να διατηρήσετε ή να διαγράψετε.',
