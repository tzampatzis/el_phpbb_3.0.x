...
*
* @package language
* @version $Id: permissions.php 11765 2012-03-30 01:00:08Z git-gate $
...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Αυτές χρησιμοποιούνται για να ελέγξουν την πρόσβαση σε ένα γενικό επίπεδο και ισχύουν για ολόκληρη την Δ. Συζήτηση. Διαιρούνται περαιτέρω σε δικαιώματα μέλους, δικαιώματα ομάδας, διαχειριστές και Δ. Συζήτησης-καθολικοί συντονιστές.</p>

		<h2>Δ. Συζήτηση με βάση τις προσβάσεις</h2>
		<p>Αυτές χρησιμοποιούνται για να ελέγξουν την πρόσβαση στο ανά βάση Δ. Συζήτηση. Διαιρούνται περαιτέρω σε δικαιώματα Δ. Συζήτησης, συντονιστές Δ. Συζήτησης, συγκεκριμένα δικαιώματα Δ. Συζήτησης μέλους και ομάδας-συγκεκριμένα δικαιώματα Δ. Συζήτησης.</p>
		...
		<p>Για περισσότερες πληροφορίες στην οργάνωση και τη διαχείριση των αδειών στο phpBB3 Δ. Συζήτησή σας, παρακαλώ δείτε <a href="https://www.phpbb.com/support/documentation/3.0/quickstart/quick_permissions.html">Chapter 1.5 of our Quick Start Guide</a>.</p>
	',
	...
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'Εδώ μπορείτε να καθορίσετε τα καθολικά δικαιώματα στις ομάδες - δικαιώματα μελών, τα δικαιώματα των καθολικών συντονιστών και τα δικαιώματα διαχειριστών. Τα δικαιώματα μελών περιλαμβάνουν τις ικανότητες όπως η χρήση των ειδώλων, η αποστολή προσωπικών μηνυμάτων κ.λ.π. τα δικαιώματα καθολικών συντονιστών όπως η έγκριση των δημοσιεύσεων, η διαχείριση θεμάτων, η διαχείριση απαγορεύσεων, κ.λ.π. και τελικά τα δικαιώματα των διαχειριστών όπως η αλλαγή των αδειών, ο καθορισμός της χρήσης BBCodes, η διαχείριση των Δ. Συζητήσεων κ.λ.π. Δικαιώματα μεμονωμένου μέλους καλό θα είναι να αλλάζουν σε ειδικές περιπτώσεις, συνιστάται ορίζεται κάποια ομάδα για τα μέλη και να ορίζεται τα δικαιώματα ολόκληρης της ομάδας.',
	...
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'Εδώ μπορείτε να ορίσετε τα καθολικά δικαιώματα στα μέλη - δικαιώματα πρόσβασης των μελών, τα καθολικά δικαιώματα συντονιστών και τα δικαιώματα των διαχειριστών. Τα δικαιώματα μελών περιλαμβάνουν τις δυνατότητες όπως η χρήση των ειδώλων, η αποστολή προσωπικών μηνυμάτων, κ.λ.π. τα καθολικά δικαιώματα συντονιστών όπως είναι η έγκριση δημοσιεύσεων, η διαχείριση θεμάτων, η διαχείριση απαγορεύσεων, κ.λ.π. και τελικά τα δικαιώματα των διαχειριστών όπως η αλλαγή των αδειών, ο καθορισμός της χρήσης BBCodes, η διαχείριση Δ. Συζητήσεις, κ.λ.π.. Για να αλλάξετε αυτές τις ρυθμίσεις για μεγάλο αριθμό μελών το σύστημα δικαιωμάτων ομάδας είναι η συνιστώμενη μέθοδος. Δικαιώματα μεμονωμένου μέλους καλό θα είναι να αλλάζουν σε ειδικές περιπτώσεις, συνιστάται ορίζεται κάποια ομάδα για τα μέλη και να ορίζεται τα δικαιώματα ολόκληρης της ομάδας.',
	...
	'SET_USERS_FORUM_PERMISSIONS'	=> 'Καθορισμός δικαιωμάτων πρόσβασης μέλους στην Δ. Συζήτηση',
