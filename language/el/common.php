...
*
* @package language
* @version $Id: common.php 11840 2012-04-19 23:15:16Z git-gate $
...
$lang = array_merge($lang, array(
	...
	'AVATAR_WRONG_FILESIZE'			=> 'Το μέγεθος αρχείου άβαταρ πρέπει να είναι μεταξύ 0 και %1$d %2$s.',
	'AVATAR_PHP_SIZE_OVERRUN'		=> 'Το άβαταρ είναι πάρα πολύ μεγάλο. Το μέγιστο μέγεθος αρχείου που επιτρέπεται στο php.ini έχει καθοριστεί %1$d %2$s. <br />Παρακαλώ αυτό έχει οριστεί στο php.ini και δεν μπορεί να αγνοηθεί.',
	'AVATAR_REMOTE_UPLOAD_TIMEOUT'		=> 'Το συγκεκριμένο άβαταρ δεν μπορεί να μεταφορτωθεί επειδή έληξε το χρονικό όριο του αιτήματος.',
	...
	'AVATAR_WRONG_SIZE'				=> 'Το συγκεκριμένο άβαταρ είναι %5$d εικονοστοιχεία πλάτος και %6$d εικονοστοιχεία ύψος. Το άβαταρ πρέπει να είναι τουλάχιστον %1$d εικονοστοιχεία πλάτος και %2$d εικονοστοιχεία ύψος, αλλά όχι μεγαλύτερο από %3$d εικονοστοιχεία πλάτος και %4$d εικονοστοιχεία ύψος.',
	...
	'BCC'					=> 'BCC',
	'BIRTHDAYS'				=> 'Γενέθλια',
	'BOARD_BAN_PERM'		=> 'Έχετε απαγορευθεί <strong>μόνιμα</strong> από αυτήν την Δ. Συζήτηση.<br /><br />Παρακαλούμε ελάτε σε επικοινωνία με τον %2$sΔιαχειριστή της Δ. Συζήτησης%3$s για περισσότερες πληροφορίες.',
	'BOARD_BAN_REASON'		=> 'Ο λόγος που σας έχει γίνει απαγόρευση: <strong>%s</strong>',
	'BOARD_BAN_TIME'		=> 'Έχετε απαγορευθεί από αυτήν την Δ. Συζήτηση μέχρι <strong>%1$s</strong>.<br /><br />Παρακαλούμε ελάτε σε επικοινωνία με τον %2$sΔιαχειριστή της Δ. Συζήτησης%3$s για περισσότερες πληροφορίες.',
	...
	'BOARD_UNAVAILABLE'		=> 'Συγγνώμη αλλά η Δ. Συζήτηση είναι αυτήν την περίοδο μη διαθέσιμη, παρακαλούμε προσπαθήστε πάλι αργότερα.',
	...
	'CONFIRM_CODE_EXPLAIN'	=> 'Πληκτρολογήστε τον κώδικα ακριβώς όπως εμφανίζεται. Δεν υπάρχει διαφορά πεζών και κεφαλαίων, το μηδέν δεν υπάρχει.',
	...
	'EMAIL_INVALID_EMAIL'				=> 'Η διεύθυνση ηλεκτρονικού ταχυδρομείου που προσθέσατε είναι άκυρη.',
	...
	'ERR_UNABLE_TO_LOGIN'				=> 'Το διευκρινισμένο όνομα μέλους ή ο κωδικός πρόσβασης είναι ανακριβής.',
	...
	'FSOCK_TIMEOUT'			=> 'Ένα χρονικό όριο συνέβη κατά την ανάγνωση από το δίκτυο.',
	...
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'Η διαδρομή του φακέλου phpbb στον οποίο βρίσκεται η ιστοσελίδα σας.',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'Για αποτροπή επιθέσεων brute forcing προς τον λογαριασμό σας το σύστημα απαιτεί να προσθέσετε έναν κώδικα επιβεβαίωσης μετά από έναν αριθμό αποτυχημένων προσπαθειών σύνδεσης. Ο κώδικας επιδεικνύεται στην εικόνα που βλέπετε πιο κάτω. Εάν είστε με οπτική αναπηρία ή δεν μπορείτε ειδάλλως να διαβάσετε αυτόν τον κώδικα παρακαλώ ελάτε σε επαφή με τον %sΔιαχειριστή της Δ. Συζήτησης%s.', // unused
	'LOGIN_ERROR_ATTEMPTS'				=> 'Έχετε υπερβεί το μέγιστο αριθμό προσπαθειών σύνδεσης. Εκτός από το όνομα μέλους και τον κωδικό πρόσβασης σας τώρα επίσης πρέπει να πληκτρολογήσετε και τον κώδικα επιβεβαίωσης από την εικόνα που βλέπετε ποιο κάτω.',
	'LOGIN_INFO'						=> 'Για να συνδεθείτε πρέπει να είστε εγγεγραμμένο μέλος. Η εγγραφή γίνεται σε λίγα μόνο λεπτά, αλλά σας παρέχει περισσότερες δυνατότητες. Επίσης οι διαχειριστές μπορεί να χορηγούν επιπρόσθετα δικαιώματα στα εγγεγραμμένα μέλη. Πριν συνδεθείτε, σιγουρευτείτε ότι γνωρίζετε τους όρους χρήσης και τις σχετικές τακτικές. Παρακαλούμε να διαβάσετε τους κανόνες της Δ. Συζήτησης κατά την πλοήγησή σας σε αυτήν..',
	'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> 'Δεν έχετε περάσει τον έλεγχο ταυτότητας του Apache.',
	'LOGIN_ERROR_PASSWORD'				=> 'Έχετε προσδιορίσει έναν άκυρο κωδικό πρόσβασης. Παρακαλούμε ελέγξτε τον κωδικό και προσπαθήστε πάλι. Εάν συνεχίσετε να έχετε προβλήματα ελάτε σε επικοινωνία με τον %sΔιαχειριστή της Δ. Συζήτησης%s.',
	...
	'LOGIN_ERROR_USERNAME'				=> 'Έχετε προσδιορίσει ένα άκυρο όνομα μέλους. Παρακαλούμε ελέγξτε το όνομα και προσπαθήστε πάλι. Εάν συνεχίσετε να έχετε προβλήματα ελάτε σε επικοινωνία με τον %sΔιαχειριστή της Δ. Συζήτησης%s.',
	'LOGIN_FORUM'						=> 'Για να δείτε τις δημοσιεύσεις σε αυτή την Δ. Συζήτηση πρέπει να δώσετε κωδικό.',
	'LOGIN_INFO'						=> 'Για να συνδεθείτε πρέπει να είστε εγγεγραμμένο μέλος. Η εγγραφή γίνεται σε λίγα μόνο λεπτά, αλλά σας παρέχει περισσότερες δυνατότητες. Επίσης οι διαχειριστές μπορεί να χορηγούν επιπρόσθετα δικαιώματα στα εγγεγραμμένα μέλη. Πριν συνδεθείτε, σιγουρευτείτε ότι γνωρίζετε τους όρους χρήσης και τις σχετικές τακτικές. Παρακαλούμε να διαβάσετε τους κανόνες της Δ. Συζήτησης κατά την πλοήγησή σας σε αυτό.',
	...
	'MODULE_NOT_ACCESS'		=> 'Η μονάδα δεν είναι προσπελάσιμη',
 	'MODULE_NOT_FIND'		=> 'Δεν μπορεί να βρεθεί η μονάδα %s',
 	'MODULE_FILE_INCORRECT_CLASS'	=> 'Το αρχείο μονάδας %s δεν περιέχει σωστή κλάση [%s]',
	'MONTH'					=> 'Μήνας',
	'MOVE'					=> 'Μετακίνηση',
	'MSNM'					=> 'MSNM/WLM',
	...
	'NO_STYLE_DATA'				=> 'Δεν μπορεί να πάρει τα δεδομένα στυλ',
	...
	'POST_BY_AUTHOR'		=> 'από',
	'POST_BY_FOE'			=> 'Η δημοσίευση δημιουργήθηκε από τον/την <strong>%1$s</strong> που βρίσκεται στην λίστα παράβλεψης. %2$sΠροβολή αυτής της δημοσίευσης%3$s.',
	...
	'TOO_LONG_AIM'	=> 'Το όνομα AIM που πληκτρολογήσατε είναι πολύ μεγάλο.',
	...
	'TOO_LONG_ICQ'	=> 'Ο αριθμός ICQ που πληκτρολογήσατε είναι πολύ μεγάλος.',
	'TOO_LONG_INTERESTS'	=> 'Τα ενδιαφέροντα που πληκτρολογήσατε είναι πολύ μεγάλα.',
	'TOO_LONG_JABBER'	=> 'Το όνομα μέλους Jabber που πληκτρολογήσατε είναι πολύ μεγάλο.',
	'TOO_LONG_LOCATION'	=> 'Η τοποθεσία που πληκτρολογήσατε είναι πολύ μεγάλη.',
	'TOO_LONG_MSN'	=> 'Το όνομα MSNM/WLM που πληκτρολογήσατε είναι πολύ μεγάλο.',
	'TOO_LONG_NEW_PASSWORD'	=> 'Ο κωδικός που πληκτρολογήσατε είναι πολύ μεγάλος.',
	'TOO_LONG_OCCUPATION'	=> 'Η ενασχόληση που πληκτρολογήσατε είναι πολύ μεγάλη.',
	...
	'TOO_LONG_EMAIL_CONFIRM'	=> 'Η επιβεβαίωση της διεύθυνσης email που πληκτρολογήσατε είναι πολύ μεγάλη.',
	'TOO_LONG_WEBSITE'	=> 'Η διεύθυνση σελίδας που πληκτρολογήσατε είναι πολύ μεγάλη.',
	'TOO_LONG_YIM'	=> 'Το όνομα Yahoo! Messenger που πληκτρολογήσατε είναι πολύ μεγάλο.',
	'TOO_MANY_VOTE_OPTIONS'	=> 'Προσπαθήσατε να ψηφίσετε για πάρα πολλές επιλογές.',

	'TOO_SHORT'						=> 'Η τιμή που προσθέσατε είναι μικρή.',

	'TOO_SHORT_AIM'	=> 'Το όνομα AIM που πληκτρολογήσατε είναι πολύ μικρό.',
	...
	'TOO_SHORT_ICQ'	=> 'Ο αριθμός ICQ που πληκτρολογήσατε είναι πολύ μικρός.',
	'TOO_SHORT_INTERESTS'	=> 'Τα ενδιαφέροντα που πληκτρολογήσατε είναι πολύ μικρά.',
	'TOO_SHORT_JABBER'	=> 'Το όνομα μέλους Jabber που πληκτρολογήσατε είναι πολύ μικρό.',
	'TOO_SHORT_LOCATION'	=> 'Η τοποθεσία που πληκτρολογήσατε είναι πολύ μικρή.',
	'TOO_SHORT_MSN'	=> 'Το όνομα MSNM/WLM που πληκτρολογήσατε είναι πολύ μικρό.',
	'TOO_SHORT_NEW_PASSWORD'	=> 'Ο κωδικός που πληκτρολογήσατε είναι πολύ μικρός.',
	'TOO_SHORT_OCCUPATION'	=> 'Η ενασχόληση που πληκτρολογήσατε είναι πολύ μικρή',
	...
	'TOO_SHORT_WEBSITE'	=> 'Η διεύθυνση σελίδας που πληκτρολογήσατε είναι πολύ μικρή',
	'TOO_SHORT_YIM'	=> 'Το όνομα Yahoo! Messenger που πληκτρολογήσατε είναι πολύ μικρό.',
	...
	'UNABLE_GET_IMAGE_SIZE'	=> 'Δεν ήταν δυνατόν να προσδιοριστούν οι διαστάσεις της εικόνας. Παρακαλώ ελέγξτε ότι το URL που εισάγατε είναι σωστό.',
	...
	'URL_REDIRECT'	=> 'Αν ο πλοηγός σας δεν υποστηρίζει ανακατεύθυνση παρακαλούμε πατήστε %sΕΔΩ%s για να μεταφερθείτε.',
	'USERGROUPS'	=> 'Ομάδες',
	...
	'WRONG_DATA_COLOUR'			=> 'Η τιμή του χρώματος που πληκτρολογήσατε είναι άκυρη.',
	
	'WRONG_DATA_ICQ'			=> 'Ο αριθμός που πληκτρολογήσατε δεν είναι έγκυρος ICQ αριθμός.',
	...
	'dateformats'	=> array(
		...
		'|F jS, Y|, g:i a'		=> 'Σήμερα, 1:37 πμ / Ιανουαρίου 1η, 2007, 1:37 πμ'
	),
