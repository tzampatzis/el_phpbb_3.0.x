...
$lang = array_merge($lang, array(
	...
	'NO_KEYWORDS'			=> 'Πρέπει να διευκρινίσετε τουλάχιστον μια λέξη στην αναζήτηση. Κάθε λέξη πρέπει να αποτελείται από τουλάχιστον %d χαρακτήρες και δεν πρέπει να περιέχει περισσότερο από %d χαρακτήρες αποκλείοντας τους μπαλαντέρ.',
	...
	'SEARCH_FORUMS_EXPLAIN'	=> 'Επιλέξτε την Δ. Συζήτηση ή τις Δ. Συζητήσεις που θέλετε να αναζητήσετε. Για ταχύτητα όλες οι υπό-συζητήσεις μπορούν να αναζητηθούν με την επιλογή του γονέα, επιλέγοντας την πιο κάτω επιλογή.',
