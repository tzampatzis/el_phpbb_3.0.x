...
$lang = array_merge($lang, array(
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'	=> 'Το σχήμα της βάσης δεδομένων σας MySQL για το  phpBB είναι ενημερωμένο. phpBB ανιχνεύει το σχήμα για  MySQL 3.x/4.x, όμως ο κεντρικός υπολογιστής τρέχει σε MySQL %2$s.<br /><strong>Πρίν συνεχίσετε την αναβάθμιση, πρέπει πρώτα να ενημερώσετε το σχήμα.</strong><br /><br />Παρακαλώ επισκεφθείτε την <a href="https://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">Βάση  Γνώσεων και το άρθρο σχετικά με την ενημέρωση του σχήματος MySQL </a>. Εάν αντιμετωπίσετε προβλήματα, παρακαλώ χρησιμοποιήστε  <a href="https://www.phpbb.com/community/viewforum.php?f=46"> το φόρουμ υποστήριξης</a>.',
	...
	'SUPPORT_BODY'				=> 'Η πλήρης υποστήριξη θα παρασχεθεί για την τρέχουσα σταθερή έκδοση phpBB3, δωρεάν. Αυτό περιλαμβάνει:</p><ul><li>εγκατάσταση</li><li>ρυθμίσεις</li><li>τεχνικές ερωτήσεις</li><li>προβλήματα σχετικά με τα πιθανά λάθη στο λογισμικό </li><li>ενημέρωση από Release Candidate (RC) εκδόσεις  στην τελευταία τελική έκδοση</li><li>μετατροπή από phpBB 2.0.x σε phpBB3</li><li>μετατροπή από άλλο λογισμικό πινάκων συζήτησης  σε phpBB3 (παρακαλώ δείτε <a href="https://www.phpbb.com/community/viewforum.php?f=65">Μετατροπή Φόρουμ</a>)</li></ul><p>Ενθαρρύνουμε τους χρήστες που τρέχουν ακόμα τις δοκιμαστικές εκδόσεις phpBB3  να αντικαταστήσουν την εγκατάστασή τους με ένα φρέσκο αντίγραφο της ποιο πρόσφατης έκδοση.</p><h2>MODs / Styles</h2><p>Για τα ζητήματα σχετικά με  MODs, παρακαλώ δημοσιεύστε μέσα στο <a href="https://www.phpbb.com/community/viewforum.php?f=81">Modifications Forum</a>.<br />Για τα ζητήματα σχετικά με  θέματα, πρότυπα και σύνολα εικόνων, παρακαλώ δημοσιεύστε μέσα στο <a href="https://www.phpbb.com/community/viewforum.php?f=80">Styles Forum</a>.<br /><br />Εάν η ερώτησή σας αφορά ένα συγκεκριμένο πακέτο, παρακαλώ δημοσιεύστε άμεσα στο θέμα που έχει οριστεί για το πακέτο.</p><h2>Λήψη Υποστήριξης</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">Το πακέτο καλώς ορίσματος  phpBB Welcome Package</a><br /><a href="https://www.phpbb.com/support/">Περιοχή Υποστήριξης</a><br /><a href="https://www.phpbb.com/support/documentation/3.0/quickstart/">Γρήγορος Οδηγός Έναρξης </a><br /><br />Για  να σιγουρευτείτε ότι έχετε τα τελευταία νέα, γιατί όχι <a href="https://www.phpbb.com/support/">εγγραφείτε στη λίστα ηλεκτρονικού   ταχυδρομείου</a>?<br /><br />',
