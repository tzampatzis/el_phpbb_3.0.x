...
$help = array(
	...
	array(
		...
		1 => 'Υπάρχουν δύο ειδών εικόνες που μπορούν να εμφανιστούν κάτω από το όνομα χρήστη όταν βλέπει δημοσιεύσεις. Η μία από αυτές μπορεί να είναι μία εικόνα που συνδέεται με το βαθμό σας, γενικά υπό την μορφή αστεριών, μπλοκ ή τελειών, που υποδεικνύει πόσες δημοσιεύσεις έχετε κάνει ή το βαθμό σας στον πίνακα συζητήσεων. Η άλλη, συνήθως μια μεγαλύτερη εικόνα, που είναι γνωστή σαν άβαταρ και είναι γενικότερα μοναδική ή προσωπική για κάθε έναν. Είναι στην κρίση του διαχειριστή να ενεργοποιήσει τα άβαταρ και να επιλέξει τον τρόπο με τον οποίο τα άβαταρ θα είναι διαθέσιμα. Αν δεν μπορείτε να χρησιμοποιήσετε τα άβαταρ, επικοινωνήστε με τον διαχειριστή και ρωτήστε τον τον λόγο για αυτό.'
	),
	array(
	...
	array(
		...
		1 => 'Αυτό το πρόγραμμα (στην αυθεντική του έκδοση) έχει υλοποιηθεί και ανήκει πνευματικά<a href="https://www.phpbb.com/">Στο phpBB Group</a>. Είναι διαθέσιμο υπό την GNU General Public License και είναι ελεύθερο. Δείτε το σύνδεσμο για περισσότερες λεπτομέρειες.'
	),
	array(
		0 => 'Γιατί δεν είναι διαθέσιμο το Χ χαρακτηριστικό;',
		1 => 'Αυτό το πρόγραμμα δημιουργήθηκε και η άδεια χρήσης του αποδόθηκε από την ομάδα ανάπτυξης λογισμικού phpBB. Αν πιστεύετε ότι ένα νέο χαρακτηριστικό  πρέπει να προστεθεί παρακαλώ επισκεφθείτε την href="https://www.phpbb.com/ideas/"> <a phpBB Ιδέες Κέντρο </ a>, όπου μπορείτε να αξιολογήστε τις υπάρχουσες ιδέες ή να προτείνετε νέες λειτουργίες.'
	),
	array(
