...
$help = array(
	...
	array(
		...
		1 => 'Αυτό το πρόγραμμα δημιουργήθηκε και η άδεια χρήσης του αποδόθηκε από την ομάδα ανάπτυξης λογισμικού phpBB. Αν πιστεύετε ότι ένα νέο χαρακτηριστικό  πρέπει να προστεθεί παρακαλώ επισκεφθείτε τo <a href="https://www.phpbb.com/ideas/">Κέντρο Ιδεών phpBB</a>, όπου μπορείτε να αξιολογήστε τις υπάρχουσες ιδέες ή να προτείνετε νέες λειτουργίες.'
	),
	array(
