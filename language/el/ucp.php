...
$lang = array_merge($lang, array(
	...
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => 'Για να αλλάξετε τον κωδικό, το ε-μαιλ σας, ή το όνομα μέλους, πρέπει να αλλάξετε τον τρέχον κωδικό.',
	...
	'MOVE_PM_ERROR'					=> 'Ένα σφάλμα σημειώθηκε κατά την μεταφορά των μηνυμάτων σε νέο φάκελο, μόνο %1$d από τα %2$d μηνύματα μετακινήθηκαν.',
