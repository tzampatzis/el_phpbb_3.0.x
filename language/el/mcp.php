...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> 'Εάν θα επιθυμούσατε να προσθέσετε μια αναφορά σχετικά με αυτό, παρακαλούμε συμπληρώστε την ακόλουθη φόρμα. Χρησιμοποιήστε μόνο σαφές κείμενο, HTML, BBCode, κ.λπ. δεν επιτρέπεται.',
	'ADD_WARNING'			=> 'Προσθέστε προειδοποίηση',
	'ADD_WARNING_EXPLAIN'	=> 'Για να στείλετε μια προειδοποίηση σε αυτό το μέλος, παρακαλούμε συμπληρώστε την ακόλουθη φόρμα. Χρησιμοποιήστε μόνο σαφές κείμενο, HTML, BBCode, κ.λπ. δεν επιτρέπεται',
	...
	'MCP_PM_REPORTS_CLOSED_EXPLAIN'	=> 'Αυτή είναι μια λίστα με όλες τις αναφορές σχετικά με τα προσωπικά μηνύματα οι οποίες προηγουμένως είχαν λυθεί.',
	'MCP_PM_REPORTS_OPEN'			=> 'Ανοιχτές αναφορές ΠΜ',
	'MCP_PM_REPORTS_OPEN_EXPLAIN'	=> 'Αυτή είναι μια λίστα με όλες τις αναφορές σχετικά με τα προσωπικά μηνύματα οι οποίες δεν έχουν λυθεί.',
 ...
 'Το επιλεγμένο θέμα μετακινήθηκε',
	...
	'UNLOCK_POST_POST_CONFIRM'		=> 'Είστε σίγουρος ότι θέλετε να επιτρέπεται η επεξεργασία της δημοσίευσης;',
	'UNLOCK_POST_POSTS'				=> 'Ξεκλειδώστε τις επιλεγμένες δημοσιεύσεις',
	'UNLOCK_POST_POSTS_CONFIRM'		=> 'Είστε σίγουρος ότι θέλετε να επιτρέπεται η επεξεργασία των επιλεγμένων δημοσιεύσεων;',
