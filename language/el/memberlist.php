...
*
* @package language
* @version $Id: memberlist.php 11840 2012-04-19 23:15:16Z git-gate $
...
$lang = array_merge($lang, array(
	...
	'CC_EMAIL'				=> 'Αποστολή αντίγραφου του μηνύματος ηλεκτρονικού ταχυδρομείου στον εαυτό σας.',
	...
	'EMAIL_TOPIC_EXPLAIN'	=> 'Αυτό το μήνυμα θα σταλεί σαν απλό κείμενο, δεν περιλαμβάνει οποιοδήποτε HTML ή BBCode κώδικα. Παρακαλούμε σημειώστε ότι οι πληροφορίες θέματος συμπεριλαμβάνονται ήδη στο μήνυμα. Ως διεύθυνση επιστροφής για αυτό το μήνυμα θα τεθεί η διεύθυνση ηλεκτρονικού ταχυδρομείου σας.',
	...
	'IM_AIM'				=> 'Παρακαλούμε σημειώστε ότι πρέπει να εγκαταστήσετε το AOL Instant Messenger για να χρησιμοποιήσετε αυτό.',
	'IM_AIM_EXPRESS'		=> 'AIM Express',
	'IM_DOWNLOAD_APP'		=> 'Μεταφορτώστε την εφαρμογή',
	'IM_ICQ'				=> 'Παρακαλούμε σημειώστε ότι τα μέλη μπορεί να έχουν επιλέξει να μην λάβουν τα εκούσια στιγμιαία μηνύματα.',
	...
	'IM_MSNM'				=> 'Παρακαλούμε σημειώστε ότι πρέπει να εγκαταστήσετε το Windows Messenger για να χρησιμοποιήσετε αυτό.',
	...
	'USERS_PER_PAGE'		=> 'Χρήστες ανά σελίδα',
