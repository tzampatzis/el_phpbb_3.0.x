...
$lang = array_merge($lang, array(
	...
	'BOOKMARK_TOPIC'		=> 'Προσθέστε στους σελιδοδείκτες',
	...
	'EDITED_TIMES_TOTAL'	=> 'Τελευταία επεξεργασία από %1$s και %2$s, έχει υποστεί επεξεργασία %3$d φορά/ες συνολικά',
	'EDITED_TIME_TOTAL'		=> 'Τελευταία επεξεργασία από %1$s και %2$s, έχει υποστεί επεξεργασία %3$d φορά/ες συνολικά',
