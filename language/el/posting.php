...
*
* @package language
* @version $Id: posting.php 11784 2012-03-31 17:45:09Z git-gate $
...
$lang = array_merge($lang, array(
	...
	'MAX_FONT_SIZE_EXCEEDED'	=> 'Το μέγιστο μέγεθος της γραμματοσειράς που επιτρέπεται %1$d.',
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> 'Το μέγιστο μέγεθος που επιτρέπεται στα δικά σας flash αρχεία είναι %1$d εικονοστοιχεία ύψος.',
	'MAX_FLASH_WIDTH_EXCEEDED'	=> 'Το μέγιστο μέγεθος που επιτρέπεται στα δικά σας flash αρχεία είναι %1$d εικονοστοιχεία πλάτος.',
	'MAX_IMG_HEIGHT_EXCEEDED'	=> 'Το μέγιστο μέγεθος που επιτρέπεται στις δικές σας εικόνες είναι %1$d εικονοστοιχεία ύψος.',
	'MAX_IMG_WIDTH_EXCEEDED'	=> 'Το μέγιστο μέγεθος που επιτρέπεται στις δικές σας εικόνες είναι %1$d εικονοστοιχεία πλάτος',
	...
	'POST_CONFIRM_EXPLAIN'		=> 'Για αποτροπή αυτόματων απαντήσεων η Δ. Συζήτηση απαιτεί την προσθήκη ενός κώδικα επιβεβαίωσης. Ο κώδικας εμφανίζεται στην πιο κάτω εικόνα. Εάν έχετε οπτικό πρόβλημα ή για κάποιον άλλο λόγο δεν βλέπετε την εικόνα ελάτε σε επικοινωνία με τον %sΔιαχειριστή της Δ. Συζήτησης%s.',
	...
	'REMOTE_UPLOAD_TIMEOUT'		=> 'Το συγκεκριμένο αρχείο δεν μπορεί να μεταφορτωθεί γιατί το χρονικό όριο του αιτήματος έχει λήξει.',
	'SAVE'						=> 'Αποθήκευση',
	...
	'TOO_MANY_CHARS_POST'		=> 'Η δημοσίευσή σας αποτελείται από %1$d χαρακτήρες. Ο μέγιστος αριθμός που επιτρέπεται είναι %2$d.',
	'TOO_MANY_CHARS_SIG'		=> 'Η υπογραφή σας αποτελείται από %1$d χαρακτήρες. Ο μέγιστος αριθμός που επιτρέπεται είναι %2$d.',
	'TOO_MANY_POLL_OPTIONS'		=> 'Έχετε προσθέσει πολλές επιλογές απαντήσεων.',
	'TOO_MANY_SMILIES'			=> 'Στο μήνυμά σας έχετε προσθέσει πολλά εικονίδια. Ο μέγιστος αριθμός εικονιδίων που επιτρέπεται είναι %d.',
	'TOO_MANY_URLS'				=> 'Στο μήνυμά σας έχετε προσθέσει πολλούς συνδέσμους. Ο μέγιστος αριθμός συνδέσμων που επιτρέπεται είναι %d.',
